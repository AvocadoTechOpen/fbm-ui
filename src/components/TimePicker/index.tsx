...
export interface TimePickerProps {
  ...
  InputProps?: FormItemProps['InputProps'];
  disabled?: boolean;
  sx?: FormItemProps['sx']
}
...
const PopupIcon: React.FC<PopupIconProps> = styled(ArrowDropDownIcon)(({ disabled, theme }: PopupIconProps) => {
  return {
...
const TimePicker: React.FC<TimePickerProps> = React.forwardRef((props, ref) => {
  ...
  return (
    <AutocompleteRoot
      ...
      freeSolo={true}
      forcePopupIcon={true}
      popupIcon={<PopupIcon disabled={disabled} />}
      disabled={disabled}
